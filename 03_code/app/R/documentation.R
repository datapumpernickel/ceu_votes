...
# DataTable
datatable_colnames <- c('Year','Country', 'Policy Area', 'in Favour', 'Abstained', "Against", "not participating")
datatable_colnames_consensus <- c('Year', 'Policy Area', 'Number of Votes', 'Number of Decisions adopted by Consensus', "Percentage of Decisions adopted by Consensus")
