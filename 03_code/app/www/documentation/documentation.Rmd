...
<!-- <div style="float: right; width: 30%; margin-right: 10px; margin-left: 20px"> -->

<!-- ```{r chunk, echo = F, warning=F, message=F} -->


<!-- something <- dplyr::tibble( -->
<!--   country = c( -->
<!--     "Belgium", -->
<!--     "Bulgaria", -->
<!--     "Czechia", -->
...
<!-- ) -->
<!-- ``` -->
<!-- **Country Codes:** For a better overview, the Council Tracker uses these country codes in its tables and graphs. -->
